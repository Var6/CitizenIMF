  ...
  const faqs = [
    {
      ...
      answer:
        'Shop insurance covers your business premises, stock, equipment, and provides liability protection against customer injuries or property damage claims.',
    },
    {
      question: 'Is shop insurance mandatory?',
      answer:
        'While not legally mandatory, shop insurance is essential to protect your business investment and comply with lease requirements from most landlords.',
    },
    {
      question: 'How is the premium calculated?',
      answer:
        'Premium depends on your business type, shop area, location, stock value, and coverage amount. High-risk businesses may have higher premiums.',
    },
  ]
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await sendEmail({
        ...
        type: window.location.href, // current page URL
        mobile: formData.mobile,
        city: formData.location,
      })

      alert('✅ Thank you! We will send you shop insurance quotes shortly.')
    } catch (error) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-yellow-400 to-orange-500 text-white py-3 rounded-lg font-bold text-lg shadow-lg hover:shadow-xl transition-all hover:cursor-pointer"
                >
                  Get Free Quotes Now
                </button>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 lg:px-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">
            We Cover All Business Types
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {businessTypes.map((business, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-4 text-center shadow-sm hover:shadow-lg transition-all group"
              >
