...
export default function FourWheelerInsurancePage() {
  ...
  const benefits = [
    {
      ...
      description: 'Protection against theft, accidents, natural disasters and fire damage to your car',
      color: 'from-blue-500 to-cyan-500'
    },
    {
      icon: '👥',
      title: 'Third Party Liability',
      description: 'Legal protection against third-party injury, death and property damage claims up to ₹15 Lakh',
      color: 'from-green-500 to-emerald-500'
    },
    {
      icon: '🔧',
  ...
  const companies = [
    { name: 'HDFC ERGO', rating: 4.5, claimRatio: '97.2%', logo: '/companies/hdfc-ergo.png' },
    { name: 'ICICI Lombard', rating: 4.4, claimRatio: '96.5%', logo: '/companies/icici-lombard.png' },
    { name: 'Bajaj Allianz', rating: 4.3, claimRatio: '95.8%', logo: '/companies/bajaj-allianz.png' },
    { name: 'Reliance General', rating: 4.2, claimRatio: '94.9%', logo: '/companies/reliance-general.png' },
    { name: 'Tata AIG', rating: 4.1, claimRatio: '93.7%', logo: '/companies/tata-aig.png' },
    { name: 'Oriental Insurance', rating: 4.0, claimRatio: '92.4%', logo: '/companies/oriental-insurance.png' }
  ]

  const coverageFeatures = {
    thirdparty: [
      'Third-party liability coverage up to ₹7.5 Lakh',
      ...
      'Most affordable car insurance option'
    ],
    comprehensive: [
      'Complete own damage + third party coverage',
      'Theft and burglary protection',
      'Natural disaster coverage (flood, earthquake)',
    ...
    zerodep: [
      'Zero depreciation on car parts',
  ...
  const steps = [
    {
      ...
      description: 'Provide your car registration number and basic details',
      icon: '🚗'
    },
    {
      step: '02',
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <motion.div
          className="absolute -top-40 -left-40 w-80 h-80 bg-gradient-to-br from-blue-400/10 to-green-400/10 rounded-full blur-3xl"
          animate={{
            x: [0, 100, 0],
            y: [0, -50, 0],
            scale: [1, 1.1, 1],
        ...
        />
        <motion.div
          className="absolute top-20 -right-40 w-96 h-96 bg-gradient-to-br from-purple-400/10 to-blue-400/10 rounded-full blur-3xl"
          animate={{
            x: [0, -80, 0],
            y: [0, 100, 0],
            scale: [1, 0.8, 1],
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-green-600 text-white relative z-10 overflow-hidden">
        <motion.div 
          ...
          animate={{
            background: [
              "linear-gradient(45deg, rgba(37,99,235,0.1), rgba(147,51,234,0.1), rgba(34,197,94,0.1))",
              "linear-gradient(90deg, rgba(147,51,234,0.1), rgba(34,197,94,0.1), rgba(37,99,235,0.1))",
              "linear-gradient(135deg, rgba(34,197,94,0.1), rgba(37,99,235,0.1), rgba(147,51,234,0.1))"
            ]
          }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl lg:text-6xl font-bold mb-6 leading-tight">
                Car
                <span className="text-transparent bg-gradient-to-r from-yellow-300 to-green-300 bg-clip-text"> Insurance</span>
              </h1>
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Protect your car with comprehensive insurance starting from ₹2,200/year. Get instant quotes, cashless repairs at 6500+ garages, and 24/7 roadside assistance.
              </p>
            ...
            >
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
                Get Instant Car Insurance Quote
              </h3>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Car Brand & Model</label>
                    <select
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Select the perfect car insurance plan that matches your needs and budget
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
              Why Choose Our <span className="text-transparent bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text">Car Insurance?</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive car protection with industry-leading benefits and nationwide service
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">Choose from India's most trusted car insurance companies</p>
          </motion.div>
      ...
      <section ref={sectionRef} className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">How to Buy Car Insurance</h2>
            <p className="text-xl text-gray-600">Simple 4-step process to get your car insured</p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-green-600 text-white relative overflow-hidden">
        <motion.div 
          ...
          animate={{
            background: [
              "linear-gradient(45deg, #2563eb, #9333ea, #22c55e)",
              "linear-gradient(90deg, #9333ea, #22c55e, #2563eb)",
              "linear-gradient(135deg, #22c55e, #2563eb, #9333ea)",
              "linear-gradient(180deg, #2563eb, #9333ea, #22c55e)"
            ]
          }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <motion.h3 
            className="text-4xl lg:text-6xl font-bold mb-6 text-transparent bg-gradient-to-r from-yellow-300 to-green-300 bg-clip-text"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Join over 5 lakh+ satisfied car owners who trust Citizen IMF for their car insurance needs. Get instant quotes and drive with confidence today.
          </motion.p>
          ...
          >
            {[
              ...
              { icon: "🔧", title: "6500+", desc: "Network Garages" },
              { icon: "🚨", title: "24/7", desc: "Roadside Assistance" },
              { icon: "💯", title: "97.2%", desc: "Claim Settlement" }
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Car Insurance FAQs</h2>
            <p className="text-xl text-gray-600">Get answers to common car insurance questions</p>
          </motion.div>
            ...
            {[
              {
                ...
                a: "Yes, third-party insurance is mandatory for all cars as per the Motor Vehicle Act, 1988. Driving without valid insurance can result in fines up to ₹2,000 and/or imprisonment up to 3 months."
              },
              {
                q: "What is the difference between third-party and comprehensive insurance?",
                a: "Third-party insurance covers only third-party damages and liabilities up to ₹7.5 Lakh for property and ₹15 Lakh for injury/death. Comprehensive insurance includes third-party coverage plus own damage protection against theft, accidents, natural disasters, and fire."
              },
              {
                q: "Can I buy car insurance online?",
                a: "Yes, you can easily buy car insurance online in just 2 minutes. Our platform offers instant quotes, policy comparison, and immediate policy issuance with all major insurers."
              },
              {
                q: "What documents are required for car insurance?",
                a: "You need your car's registration certificate (RC), valid driving license, Aadhaar card, previous policy copy (for renewal), and passport-size photographs for car insurance."
              },
              {
                q: "What is No Claim Bonus (NCB) in car insurance?",
                a: "NCB is a discount on your premium for every claim-free year. You can get up to 50% discount on your car insurance premium. NCB belongs to the policyholder, not the vehicle, and can be transferred to a new car."
              },
              {
                q: "What is Zero Depreciation cover in car insurance?",
                a: "Zero Depreciation cover ensures that you get the full claim amount without any depreciation deduction on car parts. This add-on is available for cars up to 5 years old and provides maximum claim settlement value."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
