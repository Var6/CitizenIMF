          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-200 text-sm">
              <li className="flex items-start">
                ...
                <span>C/o Shanti Devi Nivas (Besides Irrigation Office) , By Pass Road, Anisabad, Patna -2</span>
              </li>
              <li className="flex items-center">
                ...
                <Link href="mailto:hello@citizenimf.com" className="hover:text-yellow-400 transition-colors">hello@citizenimf.com</Link>
              </li>
              <li className="flex items-center">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
